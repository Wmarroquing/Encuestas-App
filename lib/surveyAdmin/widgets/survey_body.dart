...
class SurveyAdminBody extends StatefulWidget {
  final SurveyModel? survey;
  const SurveyAdminBody({super.key, required this.survey});

  @override
  State<SurveyAdminBody> createState() => _SurveyAdminBodyState();
}

class _SurveyAdminBodyState extends State<SurveyAdminBody> {
  ...
  void initState() {
    ...
    if (widget.survey != null) {
      final SurveyModel editSurvey = widget.survey!;
      setState(() {
        _isEditView = true;
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return CustomAlertDialog(
          ...
          description:
              'Deseas descartar esta encuesta? todos los datos que no hayas guardado se perderán',
